...
export function DeactivateUserDialog({ user, open, onClose, onConfirm }: DeactivateUserDialogProps) {
        ...
        <AlertDialogHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <AlertDialogTitle className="text-xl">
              {isActivating ? t('users.actions.activate') : t('users.actions.deactivate')}
            </AlertDialogTitle>
          </div>
