...
export function WalletsPagination({ pagination, onPageChange, onLimitChange }: WalletsPaginationProps) {
    ...
    <div className="flex items-center justify-between bg-card px-6 py-4 rounded-2xl shadow-sm border relative z-20">
      <div className="flex items-center gap-4">
        <div className="text-sm text-muted-foreground">
          {t('wallets.table.showingResults', { from: startIndex, to: endIndex, total: totalDocs })}
        </div>
