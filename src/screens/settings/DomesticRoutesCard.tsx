...
import { RouteFormDrawer } from '@/screens/domestic/routes/RouteFormDrawer';
import { DeleteRouteDialog } from '@/screens/domestic/routes/DeleteRouteDialog';
...
export function DomesticRoutesCard() {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-foreground">
              {t('domestic.admin.routes.title', 'Domestic Routes')}
            </h2>
